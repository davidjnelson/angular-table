ngular.module("angular-table",[]).directive("angularTable",["ScrollingContainerHeightState","JqLiteExtension","SortState","ResizeHeightEvent","TemplateStaticState","Instrumentation",function(f,a,c,b,d,g){return{restrict:"E",compile:function(a,h){c.sortExpression=h.defaultSortColumn;d.instrumentationEnabled=h.instrumentationEnabled;a.addClass("angularTableContainer");var j=a[0].outerHTML.replace("<angular-table","<div"),j=j.replace("</angular-table>","</div>");a.replaceWith(j);return function(a,c){a.ResizeHeightEvent=
